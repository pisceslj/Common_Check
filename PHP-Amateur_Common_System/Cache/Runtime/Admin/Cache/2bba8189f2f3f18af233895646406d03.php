            ...
            <?php if(is_array($sub_menu)): foreach($sub_menu as $key=>$sv): ?><li><a href="<?php echo ($sv["url"]); ?>"><?php echo ($sv["title"]); ?></a></li><?php endforeach; endif; ?>
                ...
                <div id="Right">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($notice)): $i = 0; $__LIST__ = $notice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["notice_id"]); ?>">
                                <td><?php echo ($vo["notice_subject"]); ?></td>
                                <td><?php echo ($vo["notice_content"]); ?></td>
                                <td><?php if(($vo["notice_user_id"] == 0)): ?>管理员
                                <?php elseif($vo["notice_user_id"] == 1): ?>教务处
                                <?php else: ?>老师<?php endif; ?></td>
                                <td><?php echo ($vo["notice_update_time"]); ?></td>
