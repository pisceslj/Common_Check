                ...
                <div id="Right">
                    ...
                    <form>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                            ...
                            <tbody>
                                <?php if(is_array($stuInfo)): $i = 0; $__LIST__ = $stuInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tab): $mod = ($i % 2 );++$i;?><tr align="center">
                                        <td><?php echo ($tab["stu_id"]); ?></td>
                                        <td><?php echo ($tab["stu_name"]); ?></td>
                                        <td><?php if($tab["stu_major"] == 1): ?>电子工程
                                        <?php elseif($tab["stu_major"] == 2): ?>通信工程
                                        <?php elseif($tab["stu_major"] == 22): ?>软件工程
                                        <?php else: endif; ?></td>
