        ...
        <ul>
            ...
            <div id="Right">
                <div class="contentArea">
                    ...
                    <form action="<?php echo U('Access/addUser');?>" method="post">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            <tr>
                                <th width="120">新账号：</th>
                                <td><input <?php if(ACTION_NAME == 'editUser'): ?>disabled="disabled"<?php endif; ?> name="user_name" type="text" class="input" size="40" value="<?php echo ($info["user_name"]); ?>" /></td>
                            </tr>
                            <tr>
                                <th>新密码：</th>
