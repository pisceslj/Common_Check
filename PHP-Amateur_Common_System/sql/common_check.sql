...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-05-05 05:32:48
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
INSERT INTO `ess_student` (`stu_id`, `he_id`, `stu_class_id`, `stu_name`, `stu_eng_name`, `stu_gender`, `stu_grade`, `stu_schooloing_length`, `stu_major`, `stu_entr_time`, `stu_grad_time`, `stu_is_fulltime`, `stu_is_dropping_out`, `stu_is_quitting`, `stu_campus_id`, `stu_mobile`, `stu_email`, `stu_qq`, `stu_notes`, `uuf_id`, `tch_name`) VALUES
(2014220301006, 2, 2014220301, '肖仕华', 'Tom', 1, 2014, 4, 22, '2014-09-01', '2018-09-01', 1, 0, 0, 1, 13402889081, 'xioashihua@sina.cn', 2518194537, '无', 2014220301006, '王小明'),
(2014220301019, 2, 2014220301, '卢杰', 'Mike', 1, 2014, 4, 22, '2014-09-01', '2018-09-01', 1, 0, 0, 1, 13402889170, 'lujie19960319@sina.cn', 2717561261, '无', 2014220301019, '王小明');
...
(220001, 1, 1, 1, 22, 4, '王小明', 1, '副教授', 2861990632, 13402889000, '123456@uestc.edu.cn', 123456789, '无');
...
CREATE TABLE IF NOT EXISTS `ess_ugp_uploaded_file` (
  `uuf_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `ufc_id` int(11) NOT NULL,
...
(1, 2, 3, 1, 2014220301006, '阅读需求与信息素养教育模式研究——以电子科技大学图书馆为例.', '572218f925bdf.pdf', './Uploads/', 1, '2016-04-28 14:06:49', 0),
(2, 2, 1, 1, 2014220301019, '电子科技大学计算电磁学实验室对计算电磁学的研究进展.pdf', '5720a855ca941.pdf', './Uploads/', 1, '2016-04-27 11:53:57', 0),
(3, 2, 1, 1, 2014220301019, '电子科技大学计算电磁学实验室对计算电磁学的研究进展.pdf', '5728a6c72adc9.pdf', '../Uploads/', 1, '2016-05-03 13:25:27', 0);
