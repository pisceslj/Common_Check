...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-05-05 05:33:27
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
(1, 'admin', 1461156813, '::1', '登录成功。'),
(2, 'admin', 1461570312, '::1', '登录成功。'),
(3, 'admin', 1461570387, '::1', '新增会员，会员UID：3'),
(4, 'admin', 1461758840, '::1', '登录成功。'),
(5, 'admin', 1461849132, '::1', '登录成功。');
...
(3, 'lujie', '', 1, 1461686400, '13402889170', '2717561261', 'lujie19960319@sina.cn', '80c62fa247dc1b991ea908d9a44a25b1', 1461570387);
